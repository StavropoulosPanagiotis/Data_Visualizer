...
public class VenueService {
	...
	public List<VenueResult> searchVenues(String name, String type, int fromYear, int toYear) throws SQLException { return repository.searchVenues(name, type, fromYear, toYear); }
